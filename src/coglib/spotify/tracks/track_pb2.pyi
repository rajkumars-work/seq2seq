...
class LocalizedTitle(_message.Message):
    ...
    title: str
    subtitle: str
    def __init__(self, language: _Optional[str] = ..., is_default: bool = ..., display_text: _Optional[str] = ..., title: _Optional[str] = ..., subtitle: _Optional[str] = ...) -> None: ...
...
class Show(_message.Message):
    ...
    def __init__(self, gid: _Optional[bytes] = ..., name: _Optional[str] = ..., localized_name: _Optional[_Iterable[_Union[LocalizedString, _Mapping]]] = ..., description: _Optional[str] = ..., deprecated_popularity: _Optional[int] = ..., publisher: _Optional[str] = ..., language: _Optional[str] = ..., explicit: bool = ..., cover_image: _Optional[_Union[ImageGroup, _Mapping]] = ..., episode: _Optional[_Iterable[_Union[Episode, _Mapping]]] = ..., copyright: _Optional[_Iterable[_Union[Copyright, _Mapping]]] = ..., restriction: _Optional[_Iterable[_Union[Restriction, _Mapping]]] = ..., keyword: _Optional[_Iterable[str]] = ..., media_type: _Optional[_Union[Show.MediaType, str]] = ..., consumption_order: _Optional[_Union[Show.ConsumptionOrder, str]] = ..., interpret_restriction_using_geoip: bool = ..., sale_period: _Optional[_Iterable[_Union[SalePeriod, _Mapping]]] = ..., availability: _Optional[_Iterable[_Union[Availability, _Mapping]]] = ..., country_of_origin: _Optional[str] = ..., categories: _Optional[_Iterable[_Union[Categories, _Mapping]]] = ..., passthrough: _Optional[_Union[Show.Passthrough, str]] = ..., employee_only: bool = ..., trailer_uri: _Optional[str] = ..., html_description: _Optional[str] = ..., music_and_talk: bool = ..., authorization: _Optional[_Union[Authorization, _Mapping]] = ..., is_enterprise_content: bool = ..., show_type: _Optional[_Union[ShowType, _Mapping]] = ..., is_audiobook: bool = ..., is_creator_channel: bool = ..., is_searchable: bool = ..., deprecated_spotify_user_id: _Optional[str] = ..., is_paywall_content: bool = ..., is_podcast_show: bool = ...) -> None: ...
...
class Episode(_message.Message):
    ...
    def __init__(self, gid: _Optional[bytes] = ..., name: _Optional[str] = ..., duration: _Optional[int] = ..., audio: _Optional[_Iterable[_Union[AudioFile, _Mapping]]] = ..., localized_name: _Optional[_Iterable[_Union[LocalizedString, _Mapping]]] = ..., description: _Optional[str] = ..., number: _Optional[int] = ..., publish_time: _Optional[_Union[Date, _Mapping]] = ..., deprecated_popularity: _Optional[int] = ..., cover_image: _Optional[_Union[ImageGroup, _Mapping]] = ..., language: _Optional[str] = ..., explicit: bool = ..., show: _Optional[_Union[Show, _Mapping]] = ..., video: _Optional[_Iterable[_Union[VideoFile, _Mapping]]] = ..., video_preview: _Optional[_Iterable[_Union[VideoFile, _Mapping]]] = ..., audio_preview: _Optional[_Iterable[_Union[AudioFile, _Mapping]]] = ..., restriction: _Optional[_Iterable[_Union[Restriction, _Mapping]]] = ..., freeze_frame: _Optional[_Union[ImageGroup, _Mapping]] = ..., keyword: _Optional[_Iterable[str]] = ..., interpret_restriction_using_geoip: bool = ..., suppress_monetization: bool = ..., sale_period: _Optional[_Iterable[_Union[SalePeriod, _Mapping]]] = ..., allow_background_playback: bool = ..., availability: _Optional[_Iterable[_Union[Availability, _Mapping]]] = ..., external_url: _Optional[str] = ..., original_audio: _Optional[_Union[Audio, _Mapping]] = ..., employee_only: bool = ..., rss_guid: _Optional[str] = ..., type: _Optional[_Union[Episode.EpisodeType, str]] = ..., season_number: _Optional[int] = ..., episode_number: _Optional[int] = ..., html_description: _Optional[str] = ..., music_and_talk: bool = ..., authorization: _Optional[_Union[Authorization, _Mapping]] = ..., is_enterprise_content: bool = ..., is_paywall_content: bool = ..., content_rating: _Optional[_Iterable[_Union[ContentRating, _Mapping]]] = ..., is_audiobook_chapter: bool = ..., is_podcast_short: bool = ..., is_searchable: bool = ..., deprecated_spotify_user_id: _Optional[str] = ..., is_podcast_episode: bool = ...) -> None: ...
...
class Grant(_message.Message):
    ...
    def __init__(self, market: _Optional[str] = ..., groups: _Optional[_Iterable[str]] = ..., is_override_grant: bool = ...) -> None: ...
...
class GrantV2(_message.Message):
    ...
    def __init__(self, markets: _Optional[_Iterable[str]] = ..., group: _Optional[str] = ..., is_override_grant: bool = ..., start: _Optional[_Union[Date, _Mapping]] = ..., end: _Optional[_Union[Date, _Mapping]] = ...) -> None: ...
...
class Authorization(_message.Message):
    ...
    def __init__(self, groups: _Optional[_Iterable[str]] = ..., should_check_auth_groups: bool = ..., grants: _Optional[_Iterable[_Union[Grant, _Mapping]]] = ..., grants_v2: _Optional[_Iterable[_Union[GrantV2, _Mapping]]] = ...) -> None: ...
...
class ShowType(_message.Message):
    ...
    exclusive: bool
    adaptation: bool
    def __init__(self, original: bool = ..., exclusive: bool = ..., adaptation: bool = ...) -> None: ...
